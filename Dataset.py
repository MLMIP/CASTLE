...
class mydataset(Dataset):
    def __init__(self, pdb_tag,fea_dir):
        ...
        for pdbt in pdb_tag:
            ...
            imgs.append((pdbt,metal_fea,seq_from,seq_to,res_node_from,res_edge_from,res_index_from,atom_node_from,atom_index_from,atom_edge_from,atom2res_from,node_pos_from,basic_attn_from,label))
        self.imgs = imgs
    ...
    def __getitem__(self, index):
        pdbt,metal_fea,seq_from,seq_to,res_node_from,res_edge_from,res_index_from,atom_node_from,atom_index_from,atom_edge_from,atom2res_from,node_pos_from,basic_attn_from,label = self.imgs[index]
        return pdbt,metal_fea,seq_from,seq_to,res_node_from,res_edge_from,res_index_from,atom_node_from,atom_index_from,atom_edge_from,atom2res_from,node_pos_from,basic_attn_from,label
